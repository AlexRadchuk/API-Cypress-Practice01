...
describe('CRUD Operations', () => {
  ...
  it('Create a new students using POST', () => {
    ...
    cy.request({
      ...
      cy.log(JSON.stringify(response.body, null, 6))
  ...
  it('Update the created student using PUT', () => {
    cy.request({
      ...
      expect(response.status).to.equal(201)
      console.log(JSON.stringify(putRequestBody))
    })
  })
  ...
  /**
   * Send the rquest to delete user what we created
   * Validate its 2xx
   */
